  ...
  const login = async (credentials) => {
    ...
    try {
      ...
      if (response.data.success) {
        ...
        const backendUser = response.data.userData; // Fix: backend sends userData, not user
        const userData = {
          ...backendUser,
  ...
  const updateUserProfile = async (profileData) => {
    ...
    try {
      ...
      const transformedData = {
        ...
        email: profileData.email, // Add missing email field
      ...
      if (response.data.success) {
        const backendUpdatedUser = response.data.user; // Backend sends updated user data
